Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ENV["CONFIG_ACTION_CABLE_ALLOWED_REQUEST_ORIGINS_1"], ENV["CONFIG_ACTION_CABLE_ALLOWED_REQUEST_ORIGINS_2"]]
  ...
  # config.active_job.queue_name_prefix = "CW_Encoding_production"
